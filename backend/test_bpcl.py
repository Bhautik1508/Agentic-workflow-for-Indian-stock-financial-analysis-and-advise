...
async def main():
    ...
    sector = market_data.get("fundamental_data", {}).get("sector", "Energy")
    ...
    try:
        ...
        print("Error Data:", getattr(report, "data", {}).get("error", "OK") if getattr(report, "data", None) else "No error in data")
